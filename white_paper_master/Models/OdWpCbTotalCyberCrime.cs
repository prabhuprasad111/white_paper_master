...
[Keyless]
[Table("OD_WP_CB_TOTAL_CYBER_CRIME")]
public partial class OdWpCbTotalCyberCrime
{
    [Column("SL_NO")]
    ...
    [Column("ARR_O_STATE_TG")]
    public int? ArrOStateTg { get; set; }

    [Column("ARR_O_COUNT_TG")]
    public int? ArrOCountTg { get; set; }

    [Column("INV_IN_STATE_TG")]
    public int? InvInStateTg { get; set; }

    [Column("INV_O_STATE_TG")]
    public int? InvOStateTg { get; set; }

    [Column("INV_O_COUNT_TG")]
    public int? InvOCountTg { get; set; }
}
