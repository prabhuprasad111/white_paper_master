...
[Keyless]
[Table("OD_WP_CB_PR_U_S_144_CRPC")]
public partial class OdWpCbPrUS144Crpc
{
    [Column("SL_NO")]
    ...
    [Column("NO_PR_SUB")]
    public int? NoPrSub { get; set; }

    [Column("FROM_NAC")]
    public int? FromNac { get; set; }

    [Column("FROM_OTHER")]
    public int? FromOther { get; set; }

    [Column("PRS_L_O")]
    public int? PrsLO { get; set; }

    [Column("PER_BOUND_DOWN")]
    public int? PerBoundDown { get; set; }
