...
[Keyless]
[Table("OD_WP_CB_GAMBLING_DENSE_RAIDED")]
public partial class OdWpCbGamblingDenseRaided
{
    [Column("SL_NO")]
    ...
    [Column("NO_OF_RAID_CONDUCTED")]
    public int? NoOfRaidConducted { get; set; }
    ...
    [Column("NO_OF_CASES_REG")]
    public int? NoOfCasesReg { get; set; }
