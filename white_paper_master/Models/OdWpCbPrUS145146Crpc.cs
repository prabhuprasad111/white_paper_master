...
[Keyless]
[Table("OD_WP_CB_PR_U_S_145_146_CRPC")]
public partial class OdWpCbPrUS145146Crpc
{
    [Column("SL_NO")]
    ...
    [Column("PR_SUB")]
    public int? PrSub { get; set; }

    [Column("PR_BOUND_DOWN")]
    public int? PrBoundDown { get; set; }

    [Column("LAND_DIS_MUR_RIO")]
    public int? LandDisMurRio { get; set; }
