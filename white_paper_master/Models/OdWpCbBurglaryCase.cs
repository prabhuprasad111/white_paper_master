...
[Table("OD_WP_CB_BURGLARY_CASES")]
public partial class OdWpCbBurglaryCase
{
    [Key]
    [Column("SL_NO")]
    ...
    [Column("DAY_BURGLARY")]
    public int? DayBurglary { get; set; }

    [Column("ATTEMPT_PREP")]
    public int? AttemptPrep { get; set; }

    [Column("BURG_WITHOUT_THREFT")]
    public int? BurgWithoutThreft { get; set; }
    ...
    [Column("Amount_Pro_Stolen")]
    public int? AmountProStolen { get; set; }

    [Column("Amount_Pro_Recovered")]
    public int? AmountProRecovered { get; set; }
