...
[Keyless]
[Table("OD_WP_CB_EXPLOSIVE_SUBSTANCE_WITHOUT_IPC")]
public partial class OdWpCbExplosiveSubstanceWithoutIpc
{
    [Column("SL_NO")]
    ...
    [Column("Seizure_Ammonium_Nitrate_kg", TypeName = "decimal(18, 2)")]
    public decimal? SeizureAmmoniumNitrateKg { get; set; }

    [Column("Seizure_Detonitor_powder_gm", TypeName = "decimal(18, 2)")]
    public decimal? SeizureDetonitorPowderGm { get; set; }

    [Column("Seizure_Electric_wire_meter", TypeName = "decimal(18, 2)")]
    public decimal? SeizureElectricWireMeter { get; set; }

    [Column("Seizure_Gun_no")]
    public int? SeizureGunNo { get; set; }

    [Column("Seizure_Gunpowder_gm", TypeName = "decimal(18, 2)")]
    public decimal? SeizureGunpowderGm { get; set; }

    [Column("Seizure_Bomb_no")]
    public int? SeizureBombNo { get; set; }

    [Column("Seizure_GelatinStick_gm", TypeName = "decimal(18, 2)")]
    public decimal? SeizureGelatinStickGm { get; set; }

    [Column("Seizure_Other_Explosives_substance")]
    [StringLength(2000)]
    public string? SeizureOtherExplosivesSubstance { get; set; }
