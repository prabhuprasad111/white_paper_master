...
[Keyless]
[Table("OD_WP_CB_EXPLOSIVE_ACT_SEIZURE_WITHOUT_IPC")]
public partial class OdWpCbExplosiveActSeizureWithoutIpc
{
    [Column("SL_NO")]
    ...
    [Column("EXPLOSIVE_SEIZURE_DESCRIPTION")]
    [StringLength(2000)]
    public string? ExplosiveSeizureDescription { get; set; }
    ...
    [Column("Seizure_Gunpowder_Kg", TypeName = "decimal(18, 2)")]
    public decimal? SeizureGunpowderKg { get; set; }

    [Column("Seizure_Gunpowder_Gm", TypeName = "decimal(18, 2)")]
    public decimal? SeizureGunpowderGm { get; set; }

    [Column("Seizure_FireCracker_pkt")]
    public int? SeizureFireCrackerPkt { get; set; }

    [Column("Seizure_Bomb")]
    public int? SeizureBomb { get; set; }

    [Column("Seizure_GelatinStick_gm", TypeName = "decimal(18, 2)")]
    public decimal? SeizureGelatinStickGm { get; set; }

    [Column("Seizure_Other_Explosives")]
    [StringLength(2000)]
    public string? SeizureOtherExplosives { get; set; }
}
