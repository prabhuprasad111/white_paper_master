...
[Keyless]
[Table("OD_WP_CB_LOK_ADALAT_CASES")]
public partial class OdWpCbLokAdalatCase
{
    [Column("SL_NO")]
    ...
    [Column("TOT_C_TRIED")]
    public int? TotCTried { get; set; }

    [Column("TOT_C_DISPO")]
    public int? TotCDispo { get; set; }
