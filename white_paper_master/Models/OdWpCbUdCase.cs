...
[Keyless]
[Table("OD_WP_CB_UD_CASES")]
public partial class OdWpCbUdCase
{
    [Column("SL_NO")]
    ...
    [Column("PEN_END_F_YEAR")]
    public int? PenEndFYear { get; set; }

    [Column("REG_END_F_YEAR")]
    public int? RegEndFYear { get; set; }

    [Column("TOTAL")]
    public int? Total { get; set; }

    [Column("CLOSED_DUR_YR")]
    public int? ClosedDurYr { get; set; }

    [Column("STILL_PEN_YR")]
    public int? StillPenYr { get; set; }
