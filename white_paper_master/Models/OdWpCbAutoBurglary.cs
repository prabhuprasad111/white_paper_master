...
[Keyless]
[Table("OD_WP_CB_AUTO_BURGLARY")]
public partial class OdWpCbAutoBurglary
{
    [Column("SL_NO")]
    ...
    [Column("ST_VEHICLE_2W")]
    public int? StVehicle2w { get; set; }

    [Column("ST_VEHICLE_3W")]
    public int? StVehicle3w { get; set; }

    [Column("ST_VEHICLE_4W")]
    public int? StVehicle4w { get; set; }

    [Column("ST_VEHICLE_ABOVE")]
    public int? StVehicleAbove { get; set; }

    [Column("TOTAL_RECOVERY")]
    public int? TotalRecovery { get; set; }

    [Column("RE_VEHICLE_2W")]
    public int? ReVehicle2w { get; set; }

    [Column("RE_VEHICLE_3W")]
    public int? ReVehicle3w { get; set; }

    [Column("RE_VEHICLE_4W")]
    public int? ReVehicle4w { get; set; }

    [Column("RE_VEHICLE_ABOVE")]
    public int? ReVehicleAbove { get; set; }
