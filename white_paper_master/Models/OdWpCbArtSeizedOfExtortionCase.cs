...
[Keyless]
[Table("OD_WP_CB_ART_SEIZED_OF_EXTORTION_CASES")]
public partial class OdWpCbArtSeizedOfExtortionCase
{
    [Column("SL_NO")]
    ...
    [Column("VEHICLE_ABOVE")]
    public int? VehicleAbove { get; set; }
