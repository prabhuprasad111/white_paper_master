...
[Keyless]
[Table("OD_WP_CB_CYBER_CRIME_OTHER_F")]
public partial class OdWpCbCyberCrimeOtherF
{
    [Column("SL_NO")]
    ...
    [Column("TAMPERING")]
    public int? Tampering { get; set; }

    [Column("C_TERRORISM")]
    public int? CTerrorism { get; set; }

    [Column("DISHONESTLY")]
    public int? Dishonestly { get; set; }
