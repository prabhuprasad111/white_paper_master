...
[Keyless]
[Table("OD_WP_CB_CASES_SUPERVISED_GOS")]
public partial class OdWpCbCasesSupervisedGo
{
    [Column("SL_NO")]
    ...
    [Column("SSP_DSP")]
    public int? SspDsp { get; set; }

    [Column("ADD_SSP_ADD_DCP")]
    public int? AddSspAddDcp { get; set; }

    [Column("DSP_ACP")]
    public int? DspAcp { get; set; }

    [Column("SDPOS")]
    public int? Sdpos { get; set; }

    [Column("ISIC")]
    public int? Isic { get; set; }

    [Column("TOTAL_CASES_SUPER")]
    public int? TotalCasesSuper { get; set; }
