...
[Keyless]
[Table("OD_WP_CB_PR_U_S_107_CRPC")]
public partial class OdWpCbPrUS107Crpc
{
    [Column("SL_NO")]
    ...
    [Column("INTRIM_BOND")]
    public int? IntrimBond { get; set; }

    [Column("RIOTING_MUR")]
    public int? RiotingMur { get; set; }

    [Column("NO_PR_DROPP")]
    public int? NoPrDropp { get; set; }
