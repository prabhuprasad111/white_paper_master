...
[Keyless]
[Table("OD_WP_CB_34_A_POLICE_ACT")]
public partial class OdWpCb34APoliceAct
{
    [Column("SL_NO")]
    ...
    [Column("TA", TypeName = "decimal(18, 4)")]
    ...
    [Column("PERC_INC_LCS", TypeName = "decimal(18, 4)")]
    public decimal? PercIncLcs { get; set; }

    [Column("PERC_INC_DEC_TA", TypeName = "decimal(18, 4)")]
