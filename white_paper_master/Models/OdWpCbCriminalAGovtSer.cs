...
[Keyless]
[Table("OD_WP_CB_CRIMINAL_A_GOVT_SER")]
public partial class OdWpCbCriminalAGovtSer
{
    [Column("SL_NO")]
    ...
    [Column("N_D_EMPLOYEES")]
    [StringLength(2000)]
    public string? NDEmployees { get; set; }

    [Column("N_OFFICE_ESTA")]
    [StringLength(2000)]
    public string? NOfficeEsta { get; set; }
