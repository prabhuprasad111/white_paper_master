...
[Keyless]
[Table("OD_WP_CB_IDOL_THEFT")]
public partial class OdWpCbIdolTheft
{
    [Column("SL_NO")]
    ...
    [Column("DISPOSED_OFF")]
    public int? DisposedOff { get; set; }
    ...
    [Column("TYPE_OF_IDOL")]
    [StringLength(1000)]
    public string? TypeOfIdol { get; set; }

    [Column("TYPE_OF_METAL")]
    [StringLength(1000)]
    ...
    [Column("RECOVERY_IDOL")]
    [StringLength(1000)]
    public string? RecoveryIdol { get; set; }

    [Column("ACCUSED_DETAILS")]
    [StringLength(1000)]
