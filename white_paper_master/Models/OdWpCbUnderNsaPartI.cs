...
[Keyless]
[Table("OD_WP_CB_UNDER_NSA_PART_I")]
public partial class OdWpCbUnderNsaPartI
{
    [Column("SL_NO")]
    ...
    [Column("NAME_ADD_PARTY_AFFILI")]
    [StringLength(2000)]
    public string? NameAddPartyAffili { get; set; }
    ...
    [Column("ADD_PARTY_AFFI")]
    [StringLength(2000)]
    public string? AddPartyAffi { get; set; }
