...
[Table("OD_WP_CB_TOTAL_COG")]
public partial class OdWpCbTotalCog
{
    [Key]
    [Column("SL_NO")]
    ...
    [Column("TA", TypeName = "decimal(8, 2)")]
    ...
    [Column("PERC_INC_DEC_TA")]
    [StringLength(30)]
    [Unicode(false)]
    public string? PercIncDecTa { get; set; }
    ...
    [Column("COMPOUNDED_FR_DROPPED")]
    public int? CompoundedFrDropped { get; set; }
}
